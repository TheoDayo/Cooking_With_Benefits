    ...
    <div class="container">
      ...
      <div class="profile-details">
        ...
        <div class="details-right">
          ...
          <div class="profile-middle">
            ...
            <div class="icon2">
              ...
              <i
                class="iconify"
                data-icon="ion:heart-dislike-circle"
                data-width="1.8rem"
                data-height="1.8rem"
              >
              </i>
            ...
            <div class="icon2-text">
              <p><span>Allergic to </span>shellfish, dairy</p>
              <p><span>Dislikes</span> onion, scallion</p>
            </div>
          </div>
        ...
        <div class="lower-navbar" id="selected">
          <nav>
            <ul class="nav-links">
              <li><button class="btn active">Recipes</button></li>
