    ...
    <div class="form-header">
      ...
      <div class="form-info">
        <div class="nationality-container">
          ...
          <select name="nationality" class="select-nationality" id="select-nationality"
        ...
        <div class="dislikes-container">
          <label><b>Dislikes:&emsp;</b></label>
          <select id="select-dislikes" placeholder="Select upto 5 dislikes" multiple>
            ...
            <option value="spicy">Spicy Foods</option>
          </select>
        </div>


      </div>
      <a href="https://imagecolorpicker.com/"><input type="submit" class="submit-button" value="Continue"
